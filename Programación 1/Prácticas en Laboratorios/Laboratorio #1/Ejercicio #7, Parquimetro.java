...
public class Parquimetro_Papi {
    public static void main (String[]args) {
        ...
        if (hora_entrada == 2 || hora_entrada == 3 || hora_entrada == 4 || hora_entrada == 5){
            salida_correcta += 1;
        }
        ...
        if (mins_entrada < 0 || mins_entrada > 59 || mins_salida < 0 || mins_entrada > 59){
            salida_correcta += 1;
        }
        if (hora_entrada < 0 || hora_entrada > 24 || hora_salida < 0 || hora_entrada > 24){
            salida_correcta += 1;
        }
        ...
        //Horas Iguales
        if (hora_entrada == hora_salida && mins_salida > mins_entrada && mins_salida - mins_entrada > 30){
            hora_parqueo = 1;
        }
        ...
        if (hora_salida < hora_entrada && mins_salida > mins_entrada && dias_diferentes == true){
        ...
        if (hora_parqueo == 1 && mins_salida < mins_entrada && (60 - mins_entrada + mins_salida < 30)){
            hora_cobro = 0;
        }
        ...
        if (salida_correcta != 0){
            ...
            System.out.println(hora_parqueo);
            System.out.println(hora_cobro);
        }
    }
}
